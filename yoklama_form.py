...
# Form implementation generated from reading ui file 'yoklama_form.ui'
#
...
"}")
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(210, 30, 162, 304))
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.yoklamaBaslat_pb = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.yoklamaBaslat_pb.setObjectName("yoklamaBaslat_pb")
        self.verticalLayout_2.addWidget(self.yoklamaBaslat_pb)
        self.sonucGor_pb = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.sonucGor_pb.setObjectName("sonucGor_pb")
        self.verticalLayout_2.addWidget(self.sonucGor_pb)
        spacerItem = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_2.addItem(spacerItem)
        self.ogrenciKayit_pb = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.ogrenciKayit_pb.setObjectName("ogrenciKayit_pb")
        self.verticalLayout_2.addWidget(self.ogrenciKayit_pb)
        self.ogrenciSil_pb = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.ogrenciSil_pb.setObjectName("ogrenciSil_pb")
        self.verticalLayout_2.addWidget(self.ogrenciSil_pb)
        spacerItem1 = QtWidgets.QSpacerItem(147, 35, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_2.addItem(spacerItem1)
        self.yeniSinif_pb = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.yeniSinif_pb.setObjectName("yeniSinif_pb")
        self.verticalLayout_2.addWidget(self.yeniSinif_pb)
        self.sinifSil_pb = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.sinifSil_pb.setObjectName("sinifSil_pb")
        self.verticalLayout_2.addWidget(self.sinifSil_pb)
        self.horizontalLayoutWidget = QtWidgets.QWidget(Form)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(20, 30, 181, 32))
        ...
        self.sinifSec_cb = QtWidgets.QComboBox(self.horizontalLayoutWidget)
        self.sinifSec_cb.setObjectName("sinifSec_cb")
        self.horizontalLayout_2.addWidget(self.sinifSec_cb)
        self.horizontalLayoutWidget_2 = QtWidgets.QWidget(Form)
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(20, 70, 181, 32))
        ...
        self.tarih_de = QtWidgets.QDateEdit(self.horizontalLayoutWidget_2)
        self.tarih_de.setObjectName("tarih_de")
        self.horizontalLayout_3.addWidget(self.tarih_de)
        self.label_3 = QtWidgets.QLabel(Form)
        self.label_3.setGeometry(QtCore.QRect(20, 240, 91, 16))
        self.label_3.setObjectName("label_3")
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(Form)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(20, 300, 181, 39))
        ...
        self.sinifSec_cb2 = QtWidgets.QComboBox(self.verticalLayoutWidget_2)
        self.sinifSec_cb2.setObjectName("sinifSec_cb2")
        self.horizontalLayout_4.addWidget(self.sinifSec_cb2)
        self.verticalLayout_3.addLayout(self.horizontalLayout_4)
        self.horizontalLayoutWidget_5 = QtWidgets.QWidget(Form)
        self.horizontalLayoutWidget_5.setGeometry(QtCore.QRect(20, 260, 181, 35))
        ...
        self.sinifAd_le = QtWidgets.QLineEdit(self.horizontalLayoutWidget_5)
        self.sinifAd_le.setObjectName("sinifAd_le")
        self.horizontalLayout_5.addWidget(self.sinifAd_le)
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(90, 130, 111, 94))
        self.verticalLayoutWidget_3.setObjectName("verticalLayoutWidget_3")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_3)
        self.verticalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.ogrAd_le = QtWidgets.QLineEdit(self.verticalLayoutWidget_3)
        self.ogrAd_le.setObjectName("ogrAd_le")
        self.verticalLayout_4.addWidget(self.ogrAd_le)
        self.ogrSoyad_le = QtWidgets.QLineEdit(self.verticalLayoutWidget_3)
        self.ogrSoyad_le.setObjectName("ogrSoyad_le")
        self.verticalLayout_4.addWidget(self.ogrSoyad_le)
        self.ogrNo_le = QtWidgets.QLineEdit(self.verticalLayoutWidget_3)
        self.ogrNo_le.setObjectName("ogrNo_le")
        self.verticalLayout_4.addWidget(self.ogrNo_le)
        self.verticalLayoutWidget_4 = QtWidgets.QWidget(Form)
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(20, 130, 68, 91))
        ...
        self.yoklama_tw = QtWidgets.QTableWidget(Form)
        self.yoklama_tw.setGeometry(QtCore.QRect(380, 30, 701, 441))
        self.yoklama_tw.setObjectName("yoklama_tw")
        self.yoklama_tw.setColumnCount(7)
        self.yoklama_tw.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        font = QtGui.QFont()
        font.setPointSize(13)
        item.setFont(font)
        self.yoklama_tw.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.yoklama_tw.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.yoklama_tw.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.yoklama_tw.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.yoklama_tw.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.yoklama_tw.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.yoklama_tw.setHorizontalHeaderItem(6, item)
        self.hata_l = QtWidgets.QLabel(Form)
        self.hata_l.setGeometry(QtCore.QRect(20, 370, 331, 91))
        self.hata_l.setText("")
        self.hata_l.setObjectName("hata_l")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Öğrenci Yoklama Otomasyonu"))
        self.yoklamaBaslat_pb.setText(_translate("Form", "Yoklama başlat"))
        self.sonucGor_pb.setText(_translate("Form", "Sonuçları Görüntüle"))
        self.ogrenciKayit_pb.setText(_translate("Form", "Öğrenci Kayıt"))
        self.ogrenciSil_pb.setText(_translate("Form", "Öğrenci Sil"))
        self.yeniSinif_pb.setText(_translate("Form", "Yeni Sınıf Oluştur"))
        self.sinifSil_pb.setText(_translate("Form", "Sınıf Sil"))
        self.label.setText(_translate("Form", "Sınıf Seç :"))
        self.label_2.setText(_translate("Form", "Tarih Seç :"))
        self.label_3.setText(_translate("Form", "Sınıf İşlemleri"))
        self.label_4.setText(_translate("Form", "Sınıf Seç :"))
        self.label_5.setText(_translate("Form", "Sınıf Adı :"))
        self.label_6.setText(_translate("Form", "Yeni Öğrenci"))
        self.label_8.setText(_translate("Form", "Ad :"))
        self.label_7.setText(_translate("Form", "Soyad :"))
        self.label_9.setText(_translate("Form", "Öğr. No :"))
        item = self.yoklama_tw.horizontalHeaderItem(0)
        item.setText(_translate("Form", "İd"))
        item = self.yoklama_tw.horizontalHeaderItem(1)
        item.setText(_translate("Form", "Ad"))
        item = self.yoklama_tw.horizontalHeaderItem(2)
        item.setText(_translate("Form", "Soyad"))
        item = self.yoklama_tw.horizontalHeaderItem(3)
        item.setText(_translate("Form", "Öğrenci No"))
        item = self.yoklama_tw.horizontalHeaderItem(4)
        item.setText(_translate("Form", "Durum"))
        item = self.yoklama_tw.horizontalHeaderItem(5)
        item.setText(_translate("Form", "Tarih"))
        item = self.yoklama_tw.horizontalHeaderItem(6)
        item.setText(_translate("Form", "Top. Devamsızlık"))
